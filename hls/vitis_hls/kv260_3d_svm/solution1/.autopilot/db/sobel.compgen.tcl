...
set ID 18
set hasByteEnable 0
set MemName sobel_line_buffer_0
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $MemName BINDTYPE {storage} TYPE {ram_2p} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
set ID 19
set hasByteEnable 0
set MemName sobel_line_buffer_l1_1
set CoreName ap_simcore_mem
set PortList { 1 0 }
set DataWd 16
set AddrRange 1280
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { out_r_TREADY { I 1 bit } out_r_TVALID { O 1 bit } out_r_TDEST { O 1 vector } } \
} "
} else {
...
set InstName sobel_flow_control_loop_pipe_U
set CompName sobel_flow_control_loop_pipe
